                        ...
                        <Box className='sidebar-dimensions'>
                            <Box>
                                ...
                                <Box sx={{
                                    ...
                                    <TextField value={minWidth.toString()} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setMinWidth(e.target.value === '' ? 0 : parseInt(e.target.value) || 0)}
                            ...
                            <Box>
                                ...
                                <Box sx={{
                                    ...
                                    <TextField value={minHeight.toString()} onChange={(e: React.ChangeEvent<HTMLInputElement>) => setMinHeight(Math.max(1, parseInt(e.target.value) || 1))}
                                        variant="outlined" size="small" sx={{ width: 80, border: 'none', '& fieldset': { border: 'none' } }} />
                                ...
                                displayedItems.map((product) => {
                                    return (
                                        <Box key={product.id} className="card">
                                            {/* Using Next.js Image component with remote images */}
